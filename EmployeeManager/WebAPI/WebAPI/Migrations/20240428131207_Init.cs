        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitedDay = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobCategory_Employee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobCategory_Employee_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobCategory_Employee_JobCategory_JobCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCategory_Title",
                table: "JobCategory",
                column: "Title",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobCategory_Employee_EmployeeId",
                table: "JobCategory_Employee",
                column: "EmployeeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobCategory_Employee_JobCategoryId",
                table: "JobCategory_Employee",
